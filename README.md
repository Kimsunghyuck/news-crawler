...
주요 언론사(동아일보, 조선일보, 중앙일보)의 정치/스포츠/경제 뉴스를 자동 수집하는 크롤러 및 웹 포털입니다.

## 🌟 주요 기능

- **자동 크롤링**: 3개 카테고리(정치/스포츠/경제) × 3개 언론사 = 매일 45개 뉴스 수집
- **이미지 추출**: 각 기사의 대표 이미지 자동 수집 (Open Graph)
- **웹 포털**: 반응형 UI, 배너 슬라이더, 카테고리/언론사/날짜 필터링
...
- **Frontend**: HTML5, CSS3, Vanilla JavaScript, Swiper.js
- **Backend**: Python, BeautifulSoup4, Requests
- **Hosting**: GitHub Pages (정적 사이트)
- **Automation**: GitHub Actions (매일 오전 9시)
