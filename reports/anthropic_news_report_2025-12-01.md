...
**보고서 생성일**: 2025년 12월 01일 04:46
**총 뉴스 개수**: 15개
---

## 📑 목차

- [발표](#announcements) (10개)
- [정책](#policy) (2개)
- [제품](#product) (2개)
- [연구](#research) (1개)
...
#### Introducing Claude Sonnet 4.5Claude Sonnet 4.5 sets new benchmark records in coding, reasoning, and computer use while being Anthropic's most aligned model, accompanied by the release of the Claude Agent SDK for building capable agents

- **발표일**: 2025년 9 29일
- **원문 링크**: [https://www.anthropic.com/news/claude-sonnet-4-5](https://www.anthropic.com/news/claude-sonnet-4-5)
- **수집 시간**: 2025-12-01 04:46:22
...
#### Economic Launching the Anthropic Economic Futures Programme in the UK and Europe
...
- **데이터 출처**: [Anthropic 공식 뉴스 페이지](https://www.anthropic.com/news)
- **크롤링 시스템**: Anthropic News Crawler
- **자동 업데이트**: 6시간마다
- **데이터 형식**: JSON
